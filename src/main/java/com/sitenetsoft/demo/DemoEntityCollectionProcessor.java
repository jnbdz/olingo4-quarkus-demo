...
public class DemoEntityCollectionProcessor implements EntityCollectionProcessor {
    ...
    public void readEntityCollection(
        ...
        // Only support the Products entity set for this demo
        ...
        // Build the collection from our repository
        ...
        if (responseFormat != null && responseFormat.isCompatible(ContentType.APPLICATION_JSON)) {
            // Compact JSON array without metadata – matches your test expectations
